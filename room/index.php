					...
					<div class="modal-body">
						<div id="join" >
							...
							<div id="join-dialog" class="vertical-center">
								<h2 class="text-center font-weight-bold">Always on Video</h2>
                            	<form class="needs-validation" onsubmit="joinRoom(); return false;" novalidate>
									...
									<input type="submit" class="btn btn-lg btn-success btn-block font-weight-bold" name="commit" value="Enter Room">
                                	</form>
							</div>
						</div>
					</div>
		...
		<div id="session" style="display: none;">
				...
				<div class="col-sm-4 text-left pl-0 dropdown">
					...
					<div class="bg-dark dropdown-menu" aria-labelledby="dropdownMenuButton" style="z-index: 1000;">
						<div class="p-4 ">
                        	...
                        	<button type="button" class="btn btn-danger rounded-circle" id="buttonLeaveSession" onmouseup="leaveRoom()" value="Leave room"><i id="" class="fas fa-phone-slash fa-2x py-2 m-1"></i></button>
			...
			<div class="fixed-bottom align-items-start justify-content-end px-4" style="z-index: 10;">
				...
				<div class="row align-items-end px-2">
                	...
                	<div class="col-sm-2 col-md-2 col-lg-1 col-xl-1 text-left pl-0">
						<button type="button" class="btn btn-danger rounded-circle" id="mute-audio" onclick="muteAudio()" value="Mute Audio" > <!-- onmouseover="$('#mute-audio-alert').addClass('in');; return false;" onmouseout="$('#mute-audio-alert').removeClass('in');; return false;" -->
							<i id="audio-icons" class="fas fa-microphone-slash fa-6x py-3 m-3"></i>
						</button>
					</div>
					<div class="col-sm-1 col-md-1 text-left ml-n3">
						<button type="button" class="btn btn-danger rounded-circle" id="buttonLeaveSession" onmouseup="leaveRoom()" value="Leave room">
							<i id="" class="fas fa-phone-slash fa-2x py-2 m-1"></i>
						</button>
					</div>
					...
					<!-- Local Video Feed -->
					<div class="col-2">
						<div id="local-video-container" class="" alt="local-video"></div>
					</div>
				...
				<div class="row align-items-end h-25 p-3">
					...
					<!-- Remote Video Feeds -->
					<div class="col-sm-2">
						<div id="local-video-container" class="" alt="remote-video"></div>
					</div>
